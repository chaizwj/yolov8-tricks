...
class Sam(nn.Module):
    ...
    Attributes:
        ...
        image_encoder (ImageEncoderViT): The backbone1 used to encode the image into embeddings.
    ...
    def __init__(
        ...
        Args:
            image_encoder (ImageEncoderViT): The backbone1 used to encode the image into image embeddings.
            prompt_encoder (PromptEncoder): Encodes various types of input prompts.
