...
# 主要是这部分 的代码 全部替换了，就是 定义一些 新的 损失函数 , 有新的损失函数 ，就在复制在这个方法
...
#
#
# def bbox_iou(box1, box2, xywh=True, ratio=1, inner_GIoU=False, inner_DIoU=False, inner_CIoU=False, inner_SIoU=False,
